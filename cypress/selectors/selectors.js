export const gmapSearchSelector = {
    acceptCookiesSelector:  'span[jsname="V67aGc"]', 
    searchBoxInputSelector: '#searchboxinput',
    searchBoxSearchButtonSelector: '#searchbox-searchbutton',
    headlineSelector: 'h1',
